...
from Courses import ds_course,web_course,android_course,ios_course,uiux_course,resume_videos,interview_videos,Dataanalyst_courses
import nltk
...
# course recommendations which has data already loaded from Courses_suggestion.py
...
# sql connector
# connection = pymysql.connect(host='localhost',user='root',password='Sonam@8848',db='cv')
...
def insert_data(sec_token, ip_add, host_name, dev_user, os_name_ver, latlong, city, state, country, act_name, act_mail, act_mob, name, email, res_score, timestamp, no_of_pages, reco_field, cand_level, skills, recommended_skills, courses, pdf_name):
    ...
    if not email:
        email = 'unknown@example.com'  # Default email if missing
...
def run():
    ...
    img = Image.open('./Logo/resume_pic.png')
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with  by <a style="text-decoration: none; color: #021659;">Girls Group</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a style="text-decoration: none; color: grey;">Girls Group</a> through 
        </p>
