...
Dataanalyst_courses = [[' WScube Tech data analytics course with projects ','https://www.youtube.com/watch?v=VaSjiJMrq24&list=PLjVLYmrlmjGdRs1sGqRrTE-EMraLclJga'],
              ['Top VarSity Data Analytics full course 2025','https://www.youtube.com/watch?v=5zEt1_Nkiio&list=PLOWRNl6YgsT79ezWdEhOjvK4D-cQfr7ys'],
              ['Excel Tutorial from Basic to Advances [Free]','https://www.youtube.com/watch?v=XbyiTh-6k9Q'],
              ['Power Bi full Course in 6 hours by WSCubeTech ','https://www.youtube.com/watch?v=bQ-HTp-tx40'],
              ['Data Analysis with Python Courses ','https://www.youtube.com/watch?v=GPVsHOlRBBI'],
              ['IBM Data Analyst Complete Course ','https://www.youtube.com/watch?v=1PAy6d16ADQ'],
              ['Tableau Full Course','https://www.youtube.com/watch?v=oIw8xJ1Fy3w'],
              ['Free Data Analytics Courses Online with Certificates [Free]','https://www.mygreatlearning.com/data-analytics/free-courses'],
              ['SQL for Data Analysis in one shot','https://www.youtube.com/watch?v=l8DCPaHc5TQ'],
              ['UDEMY Data Analytics Courses and Tutorials [Free]','https://www.udemy.com/topic/data-analysis/free/?srsltid=AfmBOorKBb6H8ogh2R2tw6qSHXRsYiAMhknbwPctSVgX2bO66IBlYiNp']]
